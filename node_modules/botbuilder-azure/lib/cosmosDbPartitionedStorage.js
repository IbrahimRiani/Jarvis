...
class CosmosDbPartitionedStorage {
    ...
    constructor(cosmosDbStorageOptions) {
        ...
        if (!cosmosDbStorageOptions.authKey &&
            !(cosmosClientOptions === null || cosmosClientOptions === void 0 ? void 0 : cosmosClientOptions.tokenProvider) &&
    ...
    write(changes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.initialize();
            yield Promise.all(Object.entries(changes).map((_a) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.container) {
                if (!this.client) {
                    if (this.cosmosDbStorageOptions.tokenCredential) {
                        this.client = new cosmos_1.CosmosClient(Object.assign({ endpoint: this.cosmosDbStorageOptions.cosmosDbEndpoint, aadCredentials: this.cosmosDbStorageOptions.tokenCredential, userAgentSuffix: `${pjson.name} ${pjson.version}` }, this.cosmosDbStorageOptions.cosmosClientOptions));
                    }
                    else {
